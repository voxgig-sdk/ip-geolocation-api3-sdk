...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-geolocation-api3` | `npm install @voxgig-sdk/ip-geolocation-api3` |
| Python | `voxgig-sdk-ip-geolocation-api3` | `pip install voxgig-sdk-ip-geolocation-api3` |
| PHP | `voxgig-sdk/ip-geolocation-api3` | `composer require voxgig-sdk/ip-geolocation-api3` |
| Golang | `github.com/voxgig-sdk/ip-geolocation-api3-sdk/go` | `go get github.com/voxgig-sdk/ip-geolocation-api3-sdk/go` |
| Ruby | `voxgig-sdk-ip-geolocation-api3` | `gem install voxgig-sdk-ip-geolocation-api3` |
| Lua | `voxgig-sdk-ip-geolocation-api3` | `luarocks install voxgig-sdk-ip-geolocation-api3` |
