// Command IpGeolocationApi3-mcp is an MCP server exposing the IpGeolocationApi3
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpGeolocationApi3_list  — list records of an entity
//	IpGeolocationApi3_load  — load a single record of an entity
//
