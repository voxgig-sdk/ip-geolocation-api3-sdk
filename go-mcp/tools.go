...
type Args struct {
	Entity string         `json:"entity" jsonschema:"json"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpGeolocationApi3SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-geolocation-api3_list",
		Description: "List records from IpGeolocationApi3. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-geolocation-api3_load",
		Description: "Load a single record from IpGeolocationApi3. " +
...
func runOp(client *sdk.IpGeolocationApi3SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpGeolocationApi3SDK, name string) (sdk.IpGeolocationApi3Entity, error) {
	switch strings.ToLower(name) {
	case "json":
		return client.Json(nil), nil
