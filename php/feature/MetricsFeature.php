...
// IpGeolocationApi3 SDK metrics feature
...
class IpGeolocationApi3MetricsFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _record(IpGeolocationApi3Context $ctx, bool $ok): void
    {
