...
// IpGeolocationApi3 SDK rbac feature
...
class IpGeolocationApi3RbacFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _required(IpGeolocationApi3Context $ctx): ?string
    {
    ...
    private function _reject(IpGeolocationApi3Context $ctx, string $required): void
    {
    ...
    private function _track(IpGeolocationApi3Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
