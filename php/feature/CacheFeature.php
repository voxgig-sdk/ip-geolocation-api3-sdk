...
// IpGeolocationApi3 SDK cache feature
...
class IpGeolocationApi3CacheFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _through(IpGeolocationApi3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
