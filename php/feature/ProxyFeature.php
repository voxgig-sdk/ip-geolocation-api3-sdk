...
// IpGeolocationApi3 SDK proxy feature
...
class IpGeolocationApi3ProxyFeature extends IpGeolocationApi3BaseFeature
{
    ...
    public function init(IpGeolocationApi3Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpGeolocationApi3Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
