...
// IpGeolocationApi3 SDK idempotency feature
...
class IpGeolocationApi3IdempotencyFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _mutating(IpGeolocationApi3Context $ctx): bool
    {
