...
// IpGeolocationApi3 SDK timeout feature
...
class IpGeolocationApi3TimeoutFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _with_timeout(IpGeolocationApi3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpGeolocationApi3Context $_ctx, float $ms): void
    {
        $client = $this->client;
