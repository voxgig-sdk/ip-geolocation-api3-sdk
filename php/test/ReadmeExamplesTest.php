...
// IpGeolocationApi3 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpGeolocationApi3SDK::test)
...
{
    private const SDK_CLASS = 'IpGeolocationApi3SDK';
    ...
    private const SDK_BASE = 'ipgeolocationapi3_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipgeolocationapi3_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
