...
class JsonDirectTest extends TestCase
{
    public function test_direct_load_json(): void
    {
        $setup = json_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-json", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
