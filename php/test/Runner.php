...
class IpGeolocationApi3TestRunner
{
    ...
    {
        $live = self::getenv('IP_GEOLOCATION_API3_TEST_LIVE');
        $override = self::getenv('IP_GEOLOCATION_API3_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IP_GEOLOCATION_API3_TEST_EXPLAIN');
...
class_alias('IpGeolocationApi3TestRunner', 'Runner');
class_alias('IpGeolocationApi3Helpers', 'Helpers');
