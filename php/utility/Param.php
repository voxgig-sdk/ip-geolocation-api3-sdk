...
// IpGeolocationApi3 SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class IpGeolocationApi3Param
{
    public static function call(IpGeolocationApi3Context $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = IpGeolocationApi3Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
