...
// IpGeolocationApi3 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IpGeolocationApi3MakeRequest
{
    public static function call(IpGeolocationApi3Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IpGeolocationApi3Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IpGeolocationApi3Response($fetched);
        } else {
