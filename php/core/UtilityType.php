...
// IpGeolocationApi3 SDK utility type

class IpGeolocationApi3Utility
{
    ...
    public static function copy(IpGeolocationApi3Utility $src): IpGeolocationApi3Utility
    {
        $u = new IpGeolocationApi3Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
