...
func registerSDKWords(r *eng.Registry, client *sdk.IpGeolocationApi3SDK) {
...
func runOp(client *sdk.IpGeolocationApi3SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
