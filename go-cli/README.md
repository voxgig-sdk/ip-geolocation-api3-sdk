...
AQL-driven CLI and REPL for the IpGeolocationApi3 SDK. Positional arguments are
...
```sh
go build -o ip-geolocation-api3-cli ./...
```
...
./ip-geolocation-api3-cli list json
./ip-geolocation-api3-cli load 1 json
./ip-geolocation-api3-cli load '{id:1}' json
