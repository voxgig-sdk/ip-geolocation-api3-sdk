...
from ipgeolocationapi3_sdk.utility import register

# Load features
from ipgeolocationapi3_sdk.feature.base_feature import IpGeolocationApi3BaseFeature
from ipgeolocationapi3_sdk.features import _make_feature
...
class IpGeolocationApi3SDK:
    ...
    def get_utility(self):
        return IpGeolocationApi3Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpGeolocationApi3SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Json(self, data=None) -> "JsonEntity":
        ...
        from ipgeolocationapi3_sdk.entity.json_entity import JsonEntity
