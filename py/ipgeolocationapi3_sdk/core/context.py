...
from ipgeolocationapi3_sdk.core.control import IpGeolocationApi3Control
...
from ipgeolocationapi3_sdk.core.helpers import get_ctx_prop, to_map
...
class IpGeolocationApi3Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpGeolocationApi3Control()
        ...
        if isinstance(sp, IpGeolocationApi3Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpGeolocationApi3Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpGeolocationApi3Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpGeolocationApi3Operation({})
    ...
    def make_error(self, code, msg):
        return IpGeolocationApi3Error(code, msg, self)
