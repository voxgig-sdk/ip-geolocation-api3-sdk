# IpGeolocationApi3 SDK primary utility test
...
from ipgeolocationapi3_sdk.utility.voxgig_struct import voxgig_struct as vs
from ipgeolocationapi3_sdk import IpGeolocationApi3SDK
from ipgeolocationapi3_sdk.core.spec import IpGeolocationApi3Spec
from ipgeolocationapi3_sdk.core.result import IpGeolocationApi3Result
from ipgeolocationapi3_sdk.core.response import IpGeolocationApi3Response
from ipgeolocationapi3_sdk.core.operation import IpGeolocationApi3Operation
from ipgeolocationapi3_sdk.core.error import IpGeolocationApi3Error
from ipgeolocationapi3_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return IpGeolocationApi3Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except IpGeolocationApi3Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = IpGeolocationApi3Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = IpGeolocationApi3SDK.test(None, None)
        ...
        class TestInitFeature(IpGeolocationApi3BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IpGeolocationApi3BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = IpGeolocationApi3SDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = IpGeolocationApi3SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IpGeolocationApi3Spec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IpGeolocationApi3Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpGeolocationApi3SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = IpGeolocationApi3Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpGeolocationApi3SDK.test(None, setup_opts)
