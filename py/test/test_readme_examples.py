# IpGeolocationApi3 SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from ipgeolocationapi3_sdk import IpGeolocationApi3SDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"IpGeolocationApi3SDK": IpGeolocationApi3SDK, "os": os}
        try:
