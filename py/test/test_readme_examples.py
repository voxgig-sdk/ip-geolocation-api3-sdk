# IpGeolocationApi3 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpGeolocationApi3SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpGeolocationApi3SDK(...) and IpGeolocationApi3SDK.test(...) become
#      IpGeolocationApi3SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipgeolocationapi3_sdk"
_SDK_CLASS = "IpGeolocationApi3SDK"
