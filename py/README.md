# IpGeolocationApi3 Python SDK



The Python SDK for the IpGeolocationApi3 API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Json()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ip-geolocation-api3-sdk/releases)) or
...
```
py/
├── ipgeolocationapi3_sdk.py         -- Main SDK module
