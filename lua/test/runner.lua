...
function runner.env_override(m)
  local live = runner.getenv("IPGEOLOCATIONAPI3_TEST_LIVE")
  local override = runner.getenv("IPGEOLOCATIONAPI3_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPGEOLOCATIONAPI3_TEST_EXPLAIN")
