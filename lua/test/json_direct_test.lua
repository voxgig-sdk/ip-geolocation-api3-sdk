...
describe("JsonDirect", function()
  it("should direct-load-json", function()
    local setup = json_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-json", setup.live and "live" or "unit")
...
function json_direct_setup(mockres)
