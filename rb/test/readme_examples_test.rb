...
#      offline in seeded test mode (IpGeolocationApi3SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpGeolocationApi3_sdk.rb")
  SDK_CLASS = "IpGeolocationApi3SDK"
  ...
  SDK_BASE = "IpGeolocationApi3_sdk"
