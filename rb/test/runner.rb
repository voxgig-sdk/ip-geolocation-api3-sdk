...
module IpGeolocationApi3TestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("IP_GEOLOCATION_API3_TEST_LIVE")
    override = getenv("IP_GEOLOCATION_API3_TEST_OVERRIDE")
    ...
    explain = getenv("IP_GEOLOCATION_API3_TEST_EXPLAIN")
    m["IP_GEOLOCATION_API3_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = IpGeolocationApi3TestRunner
Helpers = IpGeolocationApi3Helpers
Vs = VoxgigStruct
