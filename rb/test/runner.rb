...
module IpGeolocationApi3TestRunner
  ...
  def self.env_override(m)
    live = getenv("IPGEOLOCATIONAPI3_TEST_LIVE")
    override = getenv("IPGEOLOCATIONAPI3_TEST_OVERRIDE")
    ...
    explain = getenv("IPGEOLOCATIONAPI3_TEST_EXPLAIN")
    m["IPGEOLOCATIONAPI3_TEST_EXPLAIN"] = explain if explain && !explain.empty?
