...
type JsonEntity struct {
	name    string
	client  *core.IpGeolocationApi3SDK
...
func NewJsonEntity(client *core.IpGeolocationApi3SDK, entopts map[string]any) *JsonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
