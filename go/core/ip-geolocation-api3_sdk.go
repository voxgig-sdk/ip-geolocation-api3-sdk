...
type IpGeolocationApi3SDK struct {
	Mode     string
...
func (sdk *IpGeolocationApi3SDK) OptionsMap() map[string]any {
...
func (sdk *IpGeolocationApi3SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpGeolocationApi3SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpGeolocationApi3SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeolocationApi3SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpGeolocationApi3SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpGeolocationApi3SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpGeolocationApi3SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpGeolocationApi3SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeolocationApi3SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpGeolocationApi3SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpGeolocationApi3SDK {
	...
	sdk := NewIpGeolocationApi3SDK(sdkopts)
	sdk.Mode = "test"
