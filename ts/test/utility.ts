...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.IPGEOLOCATIONAPI3_TEST_LIVE ||
    'TRUE' === process.env.IPGEOLOCATIONAPI3_TEST_OVERRIDE
  ) {
  ...
  m.IPGEOLOCATIONAPI3_TEST_EXPLAIN = process.env.IPGEOLOCATIONAPI3_TEST_EXPLAIN || m.IPGEOLOCATIONAPI3_TEST_EXPLAIN
