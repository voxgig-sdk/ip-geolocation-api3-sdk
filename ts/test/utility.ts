...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.IP_GEOLOCATION_API3_TEST_LIVE ||
    'TRUE' === process.env.IP_GEOLOCATION_API3_TEST_OVERRIDE
  ) {
  ...
  m.IP_GEOLOCATION_API3_TEST_EXPLAIN = process.env.IP_GEOLOCATION_API3_TEST_EXPLAIN || m.IP_GEOLOCATION_API3_TEST_EXPLAIN
