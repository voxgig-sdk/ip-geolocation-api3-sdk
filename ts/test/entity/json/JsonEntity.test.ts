...
describe('JsonEntity', async () => {
  ...
  afterEach(liveDelay('IP_GEOLOCATION_API3_TEST_LIVE'))
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API3_TEST_JSON_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['IP_GEOLOCATION_API3_TEST_JSON_ENTID']
