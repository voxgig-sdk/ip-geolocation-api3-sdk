# IpGeolocationApi3 TypeScript SDK Reference

Complete API reference for the IpGeolocationApi3 TypeScript SDK.
...
```ts
new IpGeolocationApi3SDK(options?: object)
```
...
#### `IpGeolocationApi3SDK.test(testopts?, sdkopts?)`
...
**Returns:** `IpGeolocationApi3SDK` instance in test mode.
...
Alias for `IpGeolocationApi3SDK.test()`.
...
Return the parent `IpGeolocationApi3SDK` instance.
