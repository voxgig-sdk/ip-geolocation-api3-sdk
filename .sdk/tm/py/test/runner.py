...
class IpGeolocationApi3TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpGeolocationApi3TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpGeolocationApi3TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpGeolocationApi3TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
