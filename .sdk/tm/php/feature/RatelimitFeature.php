...
// IpGeolocationApi3 SDK ratelimit feature
...
class IpGeolocationApi3RatelimitFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _acquire(IpGeolocationApi3Context $ctx): void
    {
    ...
    private function _track(IpGeolocationApi3Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
