...
// IpGeolocationApi3 SDK netsim feature
...
class IpGeolocationApi3NetsimFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _simulate(IpGeolocationApi3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpGeolocationApi3Context $ctx, array $applied): void
    {
        $client = $this->client;
