...
// IpGeolocationApi3 SDK audit feature
...
class IpGeolocationApi3AuditFeature extends IpGeolocationApi3BaseFeature
{
    ...
    private function _emit(IpGeolocationApi3Context $ctx, string $outcome): void
    {
