...
// IpGeolocationApi3 SDK clienttrack feature
...
class IpGeolocationApi3ClienttrackFeature extends IpGeolocationApi3BaseFeature
{
    ...
    public function PostConstruct(IpGeolocationApi3Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpGeolocationApi3-SDK';
