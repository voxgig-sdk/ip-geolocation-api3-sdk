...
// IpGeolocationApi3 SDK utility: graphql
//
...
class IpGeolocationApi3Graphql
{
    ...
    // equivalent.
    public static function body(IpGeolocationApi3Context $ctx): mixed
    {
    ...
    public static function errors(IpGeolocationApi3Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
