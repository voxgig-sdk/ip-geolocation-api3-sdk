...
// IpGeolocationApi3 SDK utility: fetcher

class IpGeolocationApi3Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpGeolocationApi3SDK/1.0)';
    ...
    public static function call(IpGeolocationApi3Context $ctx, string $fullurl, array $fetchdef): array
    {
